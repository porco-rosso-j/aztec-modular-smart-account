...
import SchnorrModuleContractArtifactJson from "../../contracts/validators/schnorr/target/schnorr_validator-SchnorrModule.json" assert { type: "json" };
export const SchnorrModuleContractArtifact = loadContractArtifact(
	SchnorrModuleContractArtifactJson as NoirCompiledContract
);

/**
 * Type-safe interface for contract SchnorrModule;
 */
export class SchnorrModuleContract extends ContractBase {
	private constructor(instance: ContractInstanceWithAddress, wallet: Wallet) {
		super(instance, SchnorrModuleContractArtifact, wallet);
	}
	...
	public static async at(address: AztecAddress, wallet: Wallet) {
		return Contract.at(
			address,
			SchnorrModuleContract.artifact,
			wallet
		) as Promise<SchnorrModuleContract>;
	}
	...
	public static deploy(wallet: Wallet) {
		return new DeployMethod<SchnorrModuleContract>(
			Fr.ZERO,
			wallet,
			SchnorrModuleContractArtifact,
			SchnorrModuleContract.at,
	...
	public static deployWithOpts<
		M extends keyof SchnorrModuleContract["methods"]
	>(
		opts: { publicKeysHash?: Fr; method?: M; wallet: Wallet },
		...args: Parameters<SchnorrModuleContract["methods"][M]>
	) {
		return new DeployMethod<SchnorrModuleContract>(
	...
	public static get artifact(): ContractArtifact {
		return SchnorrModuleContractArtifact;
	}
