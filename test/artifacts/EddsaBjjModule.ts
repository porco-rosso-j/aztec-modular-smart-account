...
export const EddsaBjjModuleContractArtifact = loadContractArtifact(
	EddsaBjjModuleContractArtifactJson as NoirCompiledContract
);
...
export class EddsaBjjModuleContract extends ContractBase {
	...
	public static async at(address: AztecAddress, wallet: Wallet) {
		return Contract.at(
			address,
			EddsaBjjModuleContract.artifact,
			wallet
		) as Promise<EddsaBjjModuleContract>;
	}
	...
	public static deployWithOpts<
		M extends keyof EddsaBjjModuleContract["methods"]
	>(
