...
export const EcdsaK256ModuleContractArtifact = loadContractArtifact(
	EcdsaK256ModuleContractArtifactJson as NoirCompiledContract
);
...
export class EcdsaK256ModuleContract extends ContractBase {
	...
	public static async at(address: AztecAddress, wallet: Wallet) {
		return Contract.at(
			address,
			EcdsaK256ModuleContract.artifact,
			wallet
		) as Promise<EcdsaK256ModuleContract>;
	}
	...
	public static deployWithOpts<
		M extends keyof EcdsaK256ModuleContract["methods"]
	>(
